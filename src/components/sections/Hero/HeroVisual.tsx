...
export default function HeroVisual() {
    return (
        ...
        >
            {/* Grey Background */}
            <div className="absolute inset-0 -z-20 rounded-[2.25rem] bg-gradient-to-b from-[#7f7f7f] via-[#6b6b6b] to-[#9a9a9a] opacity-90" />

            {/* Warm Glow */}
            <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 -z-10 h-64 w-[90%] rounded-full bg-[#ccaf98]/60 blur-[70px]" />
            <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 -z-10 h-64 w-[70%] rounded-full bg-[#ccaf98]/35 blur-[90px]" />
