...
export default function ServicesCard({isVisible, service, index} : ServiceCardProps) {
    ...
    >
        <div aria-hidden="true" className="h-14 w-14 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary mb-6 group-hover:scale-110 transition-transform duration-300">
