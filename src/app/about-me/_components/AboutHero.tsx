...
export function AboutHero() {
    ...
    return (
        ...
        >
            ...
            {/* ── Gradient overlays (matching main hero) ───────────── */}
            <div
            ...
            {/* ── Diagonal stripe (matching main hero) ─────────────── */}
            <div
                ...
                style={{
                    background: `linear-gradient(
                        ...
                        hsl(var(--hero-accent) / 0.18) 38%,
                        hsl(var(--hero-accent) / 0.18) 56%,
                        rgba(134, 34, 25, 0) 56%
                    )`,
                }}
            />
            ...
            <motion.div
                style={{ opacity: fade }}
                className="absolute inset-0 z-10 flex flex-col justify-end px-6 pb-12 md:px-10 md:pb-16"
            >
                <div className="mx-auto w-full max-w-[1580px]">
                    ...
                    <motion.p
                        ...
                        className="mt-5 max-w-[340px] font-light leading-relaxed md:mt-7 md:max-w-[360px]"
                        style={{
                            fontSize: "clamp(0.82rem, 2.2vw, 0.9rem)",
                            color: mid,
                        }}
                    >
                        Over 5 years solving real problems through code — from
                        Argentina to a Senior Engineer role at a Boston-based
                        company, now building from Australia.
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        className="mt-8 flex flex-wrap items-end gap-8 md:mt-10"
                    >
                        {STATS.map(({ n, l }) => (
                            <div key={l}>
                                <p
                                    className="mb-1 font-mono text-[0.5rem] uppercase tracking-[0.22em]"
                                    style={{ color: dim }}
                                >
                                    {l}
                                </p>
                                <p
                                    className="font-serif text-[1.5rem] leading-none tracking-[-0.03em]"
                                    style={{ color: white }}
                                >
                                    {n}
                                </p>
                        ...
                        <Link
                            href="/#contact"
                            className="group flex items-center gap-[0.75rem] rounded-full no-underline whitespace-nowrap"
                            style={{
                                background: accent,
                                color: white,
                            ...
                            onMouseEnter={(e) => {
                                ...
                                el.style.background =
                                    "hsl(var(--hero-accent-dark))";
                                el.style.transform = "translateY(-2px)";
                                el.style.boxShadow =
                                    "0 12px 32px hsl(var(--hero-accent) / 0.4)";
                            }}
                            onMouseLeave={(e) => {
                                const el = e.currentTarget;
                        ...
                        >
                            Book a call
                            <span
                                className="flex h-6 w-6 items-center justify-center rounded-full text-[0.85rem] transition-transform duration-200 group-hover:rotate-45 md:h-7 md:w-7"
                                style={{
                    ...
                    >
                        ...
                        <span
                            className="font-mono text-[0.5rem] uppercase tracking-[0.22em]"
            ...
            >
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(to bottom, rgba(255,255,255,0.6), rgba(134, 34, 25, 0))",
