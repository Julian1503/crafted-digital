...
function ExperienceItem({
    ...
    return (
        <motion.div
            ...
            className="grid cursor-default gap-x-10 gap-y-2 border-b py-9 max-sm:grid-cols-1"
            style={{
        ...
        >
            ...
            <div>
                ...
                <p
                    className="mb-4 max-w-[58ch] text-[0.88rem] leading-[1.88]"
    ...
    return (
        ...
        >
            <div className="mx-auto max-w-[1580px]">
                ...
                <FadeUp delay={0.06}>
                    <h2
                        className="mb-14 max-w-[24ch] font-serif text-[clamp(1.9rem,4vw,3.2rem)] font-normal leading-[1.1] tracking-[-0.035em]"
                        style={{ color: white }}
                    >
                        2017 – 2025
                    </h2>
                ...
                <div
                    className="grid gap-x-10 border-b pb-3 max-sm:hidden"
                    style={{
                ...
                <div className="flex items-stretch gap-0">
                    <div className="relative flex w-11 shrink-0 flex-col items-center max-sm:hidden">
                        ...
                        {EXPERIENCE.map((_, i) => (
                            <div
                                key={i}
                                className="relative z-[2] flex min-h-[100px] flex-1 items-center justify-center"
                            >
