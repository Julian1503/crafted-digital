...
import type { AboutPrinciple, AboutStoryBlock } from "@/lib/mappers/content-block.mapper";
...
export default function AboutContent({ principles, experienceHighlights, storyBlocks }: AboutContentProps) {
                    ...
                    <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
                        <RevealSection className="space-y-6 flex flex-col items-center" variant="left">
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                I build digital products for teams that value clarity over noise. My role is to translate your
                                vision into an experience that feels confident, premium, and easy to trust.
                            </p>
                            <div
                                ref={frameRef}
                            ...
                            >
                                <div
                                    ref={imgRef}
                                    className="absolute left-0 top-0 w-full h-[140%] will-change-transform"
                                >
                                    <Image
